...
type RobotErrorsPanelAdapterProps = {
  config: RobotErrorsConfig;
  saveConfig: SaveConfig<RobotErrorsConfig>;
};

function RobotErrorsPanelAdapter({ config, saveConfig }: RobotErrorsPanelAdapterProps) {
...
export default Panel(
  Object.assign(RobotErrorsPanelAdapter, {
    panelType: "RobotErrors",
    defaultConfig: {},
  }),
);
