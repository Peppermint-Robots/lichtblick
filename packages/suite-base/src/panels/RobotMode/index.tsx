...
type RobotModePanelAdapterProps = {
  config: RobotModeConfig;
  saveConfig: SaveConfig<RobotModeConfig>;
};

function RobotModePanelAdapter({ config, saveConfig }: RobotModePanelAdapterProps) {
...
export default Panel(
  Object.assign(RobotModePanelAdapter, {
    panelType: "RobotMode",
    defaultConfig: {},
  }),
);
